...
//extern void vert_Crab_NoAnim();
extern void SC_KingCrab_DL();
//extern void SC_KingCrab_DL_LOD1();
//extern void SC_KingCrab_DL_LOD2();

g64_NPCObjectPrefab SC_KingCrab_PF;
...
void SC_CrabPrefabs_Builder(g64_NPCObjectPrefab* prefabName, void(*displayListName), void(*displayListName2), void(*displayListName3));


void SC_CrabPrefabs_Init()
{
	SC_CrabPrefabs_Builder(&SC_KingCrab_PF, &SC_KingCrab_DL, &SC_KingCrab_DL, &SC_KingCrab_DL);
...
void SC_CrabPrefabs_Builder(g64_NPCObjectPrefab* prefabName, void(*displayListName), void(*displayListName2), void(*displayListName3)) {
	//SC_SimpleTower_DL
	SetVector3(&prefabName->obj.pos, -4, 0, 7.5); // default position... this should be updated when an instance is made
...
void SC_CrabPrefabs_Draw(g64_NPCObjectPrefab* prefabInstance) {

	gin64_RenderNPCObj(prefabInstance, 0);
}
