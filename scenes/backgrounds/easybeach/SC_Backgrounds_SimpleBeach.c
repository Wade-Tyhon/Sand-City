...
static const gl_XP64_Vert vert_Beach[] = {
      ...
      {.pos = {18.00, 9.00, 6.00}, .uv = {1.78, 0.32}, .vNormal = { -16.00, -43.00, 118.00}, .vColor = { 238, 238, 236, 255 } },
      ...
      {.pos = {-18.00, 9.00, 6.00}, .uv = {1.34, -2.05}, .vNormal = { 15.00, -38.00, 119.00}, .vColor = { 238, 238, 236, 255 } },
      ...
      {.pos = {18.00, -9.00, 6.00}, .uv = {0.54, 0.58}, .vNormal = { -16.00, 2.00, 125.00}, .vColor = { 238, 238, 236, 255 } },
      {.pos = {-18.00, -9.00, 6.00}, .uv = {0.11, -1.78}, .vNormal = { 17.00, 4.00, 125.00}, .vColor = { 238, 238, 236, 255 } },
      ...
      {.pos = {0.00, 0.00, -23.60}, .uv = {0.11, -1.78}, .vNormal = { 0.00, 0.00, 127.00}, .vColor = { 238, 238, 236, 255 } },
      {.pos = {0.00, 0.00, -23.60}, .uv = {1.34, -2.05}, .vNormal = { 0.00, 0.00, 127.00}, .vColor = { 238, 238, 236, 255 } },
      {.pos = {0.00, 0.00, -23.60}, .uv = {1.78, 0.32}, .vNormal = { 0.00, 0.00, 127.00}, .vColor = { 238, 238, 236, 255 } },
      {.pos = {0.00, 0.00, -23.60}, .uv = {0.54, 0.58}, .vNormal = { 0.00, 0.00, 127.00}, .vColor = { 238, 238, 236, 255 } },
